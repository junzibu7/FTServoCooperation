...
#include "ftservocontrol/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Landmark_type_support_symbol_names_t _Landmark_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ftservocontrol, msg, Landmark)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ftservocontrol, msg, Landmark)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_ftservocontrol
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ftservocontrol, msg, Landmark)() {
  return &::ftservocontrol::msg::rosidl_typesupport_c::Landmark_message_type_support_handle;
}
