...
#include "ftservocontrol/msg/detail/landmark__rosidl_typesupport_fastrtps_c.h"
...
#include "ftservocontrol/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ftservocontrol
...
using _Landmark__ros_msg_type = ftservocontrol__msg__Landmark;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ftservocontrol
size_t get_serialized_size_ftservocontrol__msg__Landmark(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Landmark__ros_msg_type * ros_message = static_cast<const _Landmark__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Landmark__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ftservocontrol__msg__Landmark(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ftservocontrol
size_t max_serialized_size_ftservocontrol__msg__Landmark(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_ftservocontrol__msg__Landmark(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ftservocontrol, msg, Landmark)() {
