...
bool ftservocontrol__msg__landmark__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ftservocontrol.msg._landmark.Landmark", full_classname_dest, 37) == 0);
  }
  ftservocontrol__msg__Landmark * ros_message = _ros_message;
  {  // header
...
PyObject * ftservocontrol__msg__landmark__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ftservocontrol.msg._landmark");
